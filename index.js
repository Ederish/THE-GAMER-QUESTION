...
musica = [
  new Audio("img/music.mp3"),
  new Audio("img/correct.wav"),
  new Audio("img/fail.mp3")
]; 
window.onload = function(){musica[0].play(); musica[0].loop = true;}
...
function oprimir_btn(i) {
  ...
  if (posibles_respuestas[i] == pregunta.respuesta) {
    ...
    btn_correspondiente[i].style.background = "#e50000"
    setTimeout(function(){
    document.querySelector(".gameOver").style.display = "inline-flex";
    document.querySelector(".contenedor").style.display = "none";}, 3000);
    musica[2].play();
    musica[0].pause();
  }
  for (let j = 0; j < 4; j++) {
